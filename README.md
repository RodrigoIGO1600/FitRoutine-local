...
- **Exercise library** — define exercises with muscle group, category, equipment, description, video URL, and timed/rep-based type
- **Routine builder** — add exercises to routines, configure sets/reps/duration/rest, and reorder exercises
- **Active workout tracking** — start a routine, mark sets complete, run rest and exercise timers, and track elapsed time
